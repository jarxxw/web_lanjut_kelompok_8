                ...
                <div class="col-6">
                    <form>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Jenis Kelamin</label>
                            <div class="col-sm-10">
                                <input type="radio" name="jekel" value="L" class="form-check-input" style="margin-right: 10px;" <?= ($data_mhs['jenis'] == 'L') ? 'checked' : '' ?>>Laki-Laki
                                <br>
                                <input type="radio" name="jekel" value="P" class="form-check-input" style="margin-right: 10px;" <?= ($data_mhs['jenis'] == 'P') ? 'checked' : '' ?>>Perempuan
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="email" class="col-sm-2 col-form-label">Email</label>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Hobi</label>
                            <div class="col-sm-10">
                                <input type="checkbox" name="hobi[]" value="Olahraga" <?php if (in_array('Olahraga', $hobies)) echo 'checked' ?>> Olahraga
