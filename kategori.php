<?php
include 'koneksi.php'; // Menggunakan koneksi $db (dari koneksi.php)
...
<div class="row">
    ...
    <table class="table table-border">
        ...
        <?php
        $query = $db->query("SELECT * FROM kategori"); // Gunakan $db untuk koneksi
        $no = 1;
...
<?php
    ...
    case 'edit':
        ...
        $stmt = $db->prepare("SELECT * FROM kategori WHERE id = :id"); // Gunakan $db untuk query
